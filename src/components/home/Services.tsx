  ...
  return (
    <section className="w-full bg-white py-[90px] px-6">
      <div className="max-w-7xl mx-auto px-6">
        <p className="text-[13px] tracking-[6px] uppercase text-gray-500 font-medium mb-[35px] text-center">
          WHAT WE DO
        </p>
        <h2 className="text-[42px] md:text-[58px] font-bold text-black leading-[1.15] max-w-[800px] mb-[60px] mx-auto text-center">
          A complete suite of premium event services.
        </h2>
